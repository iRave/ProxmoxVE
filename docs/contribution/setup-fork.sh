...
# upstream   https://github.com/iRave/ProxmoxVE.git (fetch)
# upstream   https://github.com/iRave/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/iRave/ProxmoxVE"
echo ""
