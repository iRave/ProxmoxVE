...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/iRave/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/iRave/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/iRave/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/iRave/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/iRave/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/iRave/ProxmoxVE/discussions)
